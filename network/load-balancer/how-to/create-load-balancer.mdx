...
3. Complete the following steps in the wizard: 
    ...
    - Choose the **Availability Zone** in which your Load Balancer will be deployed geographically. Currently we provide the following Availability Zones:
      ...
      - `WAW`: Warsaw, Poland.
      <Lightbox src="scaleway-lb-az.webp" />
    ...
    - Configure the frontend and backend.
      ...
      - **Configure backend**. Enter a name and further configuration settings for your [backend](/network/load-balancer/concepts/#backends). The backend will use this configuration to connect to the backend servers. 
        <Message type="tip">

        For more information on choosing configuration settings for your Load Balancer's frontend and backend, see our [dedicated reference documentation](/network/load-balancer/reference-content/configuring-load-balancer)
